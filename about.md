...
Natural question when you visit this page is who are you?
...
<span class='red'>IMO the best way to learn data science is not through earning a degree, I mean look at the greatest pro you can get, that is to learn from so many different courses from so many awesome professors around the world not bound to specific college per se. It's like we can go to MIT for one course, Stanford or Harvard for another, CMU or Cornell or land in USF next day for another. I mean how cool is that! And the best thing is free of cost, no traveling, no accommodation, now what can you ask more for? (Let Geff Hinton teach every course :P)</span>

Okay enough talk, I tried to declutter almost the sources and arrange it in such that anyone can start learning about DL. But before that remember what [Richard Feynman](https://dudeperf3ct.github.io/sensei/richard-feynman/) say about knowing the name of something and understanding it.
...
|[MIT 9.11: The Human Brain](https://www.youtube.com/playlist?list=PLyGKBDfnk-iAQx4Kw9JeVqspbg77sfAK0) |[6.HT 2019](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv)| [Full Stack Deep Learning Bootcamp](https://fullstackdeeplearning.com/march2019)|
