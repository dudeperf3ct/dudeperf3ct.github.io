...
We can view the mapping network and affine transformations as a way to draw samples for each style from a learned distribution, and the synthesis network as a way to generate a novel image based on a collection of styles. This synthesis network takes in the output generated by mapping network to generate image by using AdaIN with whom we had encounter with before [here](https://dudeperf3ct.github.io/style/transfer/2018/12/23/Magic-of-Style-Transfer/#arbitrary-neural-artistic-stylization-network). 
...
<p align="center">
<img src='/images/gan/ecd_pose.png' width="50%"/> 
</p>
