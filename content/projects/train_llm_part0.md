...
* Issues, and pull requests from the [GHArchive]()
...
> The code for this logic is implemented by the [`SWHDatasetParser`]() class.
...
> The code for this logic is implemented by the [`SWHContentDownloader`]() class.
